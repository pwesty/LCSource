...
event ESpawnDebrisSka {
  CEntityPointer penSpawner,    // who spawned it
  INDEX   iSkaModelComponentID, // model component ID
  ...
  BOOL    bFromModelHolder3,    // use ModelHolder3 as template?
  CEntityPointer penModelHolder3, // ModelHolder3 possibly used as template
};

%{
%}

class CDebrisSka: CMovableModelEntity {
name      "Debris";
thumbnail "";
...
procedures:
  ...
  Main(ESpawnDebrisSka eSpawn)
  {
    ...
    // SetSkaModel(eSpawn.strSMCFileName);
