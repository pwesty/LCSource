...
{
	struct doFriendAddReqToHelper : public pTypeBase
	{
		int approvalindex;
	...
	struct doFriendAddRepToHelper : public pTypeBase
	{
		int approvalindex;
		char appname[MAX_CHAR_NAME_LENGTH + 1];
		int appjob;
	...
	struct doFriendDelReqToHelper : public pTypeBase
	{
		int approvalindex;
		int requester;
		char name[MAX_CHAR_NAME_LENGTH + 1];
	...
	struct doFriendSetConditionToHelper : public pTypeBase
	{
		int chaindex;
		int condition;
		int bReply;
	...
	struct doFriendChattingToMessenger : public pTypeBase
	{
		int seq;
		int server;
		int subno;
	...
	struct doFriendDelMemberReqToHelper : public pTypeBase
	{
		int approvalIndex;
		int requesterIndex;
		char name[MAX_CHAR_NAME_LENGTH + 1];
	...
	struct doFriendDelMemberRepToGameServer : public pTypeBase
	{
		int removerIndex;
		int deleteIndex;
		int errorCode;
