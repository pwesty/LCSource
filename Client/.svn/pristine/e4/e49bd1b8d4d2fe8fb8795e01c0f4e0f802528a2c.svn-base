...
// implementation:
	...
	FLOAT ls_fAmbientAttenuation;     // attenuation factor of ambient light (depends on light angle; 0=no att, 1=max att)
...
// interface:
	...
	void Read_t( CTStream *pstrm,BOOL bNetwork);        // throw char *
	void Write_t( CTStream *pstrm,BOOL bNetwork);       // throw char *
};
