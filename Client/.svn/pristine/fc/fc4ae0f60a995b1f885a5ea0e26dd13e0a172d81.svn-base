...
properties:
  2 COLOR m_colColor                    "Color" 'C' =C_GRAY features(EPROPF_NETSEND),
  9 COLOR m_colAmbient                  "Directional ambient"  'E' =C_BLACK,
  6 FLOAT m_fAmbientAttenuation         "Ambient Attenuation" = 0.0f,
 ...
 20 CTFileName m_fnmLightAnimation      "Light animation file" = CTString("")  features(EPROPF_NETSEND),
 21 ANIMATION m_iLightAnimation         "Light animation" = 0  features(EPROPF_NETSEND),
 25 FLOAT m_tmOffsetPhase               "Light animation offset" = 0.0f  features(EPROPF_NETSEND),
//안태훈 수정 시작	//(Add Sun Moon Entity and etc)(0.1)
 50 FLOAT m_tmAniStartTime				"Light animation start time" = 0.0f,
 51 FLOAT m_fTimeMultiply = 1.0f,
//안태훈 수정 끝	//(Add Sun Moon Entity and etc)(0.1)
 22 CAnimObject m_aoLightAnimation features(EPROPF_NETSEND),
 24 BOOL m_bTargetable                  "Targetable" = FALSE,
 26 BOOL m_bDynamic                     "Dynamic" = FALSE,
 27 BOOL m_bDiffusion                   "Diffusion" 'D' = TRUE,
 30 CTFileName m_fnmAmbientLightAnimation      "Ambient light animation file" = CTString("")  features(EPROPF_NETSEND),
 31 ANIMATION m_iAmbientLightAnimation         "Ambient light animation" = 0  features(EPROPF_NETSEND),
 32 CAnimObject m_aoAmbientLightAnimation features(EPROPF_NETSEND),
{
	CLightSource m_lsLightSource;
	CBoolDefaultFalse m_bdfInitialized; // set if already initialized once
}
components:
		1 editor model   MODEL_LIGHT_SOURCE         "Data\\Models\\Editor\\LightSource.mdl",
		2 editor texture TEXTURE_POINT_LIGHT        "Data\\Models\\Editor\\PointLight.tex",
		3 editor texture TEXTURE_AMBIENT_LIGHT      "Data\\Models\\Editor\\AmbientLight.tex",
		4 editor texture TEXTURE_REAL_AMBIENT_LIGHT "Data\\Models\\Editor\\RealAmbientLight.tex",
		5 editor model   MODEL_SPOT_LIGHT           "Data\\Models\\Editor\\SpotLight.mdl",
		6 editor texture TEXTURE_SPOT_LIGHT         "Data\\Models\\Editor\\SpotLight.tex",
