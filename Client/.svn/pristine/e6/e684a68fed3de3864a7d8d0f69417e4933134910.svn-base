...
public:
  ...
  COLORREF m_SelectionColor;
	...
	int	m_iView;
	int	m_iViewConfig;
	void SetViewIndex( int iView, int iViewConfig ) 
	{
		m_iView = iView;
		m_iViewConfig =iViewConfig;
	}
...
public:
  ...
  BOOL GetButtonState(INDEX iKid);
...
public:
	...
	afx_msg void OnShadowEditMode();
	afx_msg void OnAttributeEditMode();
	afx_msg void OnPrevLayer();
	afx_msg void OnNextLayer();
	afx_msg void OnViewAttributemap();
	//}}AFX_MSG
