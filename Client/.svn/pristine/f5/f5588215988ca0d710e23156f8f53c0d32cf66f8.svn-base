...
CPerspectiveProjection3D &CPerspectiveProjection3D::operator=(const CPerspectiveProjection3D &other)
{
	pr_ObjectPlacement = other.pr_ObjectPlacement;
	pr_vObjectHandle = other.pr_vObjectHandle;
	pr_ViewerPlacement = other.pr_ViewerPlacement;
	pr_vViewerPosition = other.pr_vViewerPosition;
	pr_NearClipDistance = other.pr_NearClipDistance;
	pr_FarClipDistance = other.pr_FarClipDistance;
	pr_ScreenBBox = other.pr_ScreenBBox;
	pr_AspectRatio = other.pr_AspectRatio;
	pr_ObjectStretch = other.pr_ObjectStretch;
	pr_bFaceForward = other.pr_bFaceForward;
	pr_bHalfFaceForward = other.pr_bHalfFaceForward;
	pr_bMirror = other.pr_bMirror;
	pr_bWarp = other.pr_bWarp;
	pr_plMirror = other.pr_plMirror;
	pr_plMirrorView = other.pr_plMirrorView;
	pr_fViewStretch = other.pr_fViewStretch;
	pr_bNiceWater = other.pr_bNiceWater;
	pr_plNiceWaterView = other.pr_plNiceWaterView;
	pr_Prepared = other.pr_Prepared;
	pr_bInverted = other.pr_bInverted;
	pr_RotationMatrix = other.pr_RotationMatrix;
	pr_mDirectionRotation = other.pr_mDirectionRotation;
	pr_ViewerRotationMatrix = other.pr_ViewerRotationMatrix;
	pr_TranslationVector = other.pr_TranslationVector;
	pr_ScreenCenter = other.pr_ScreenCenter;

	pr_fDepthBufferFactor = other.pr_fDepthBufferFactor;
	pr_fDepthBufferMul = other.pr_fDepthBufferMul;
	pr_fDepthBufferAdd = other.pr_fDepthBufferAdd;
	pr_fDepthBufferNear = other.pr_fDepthBufferNear;
	pr_fDepthBufferFar = other.pr_fDepthBufferFar;
	pr_plClipL = other.pr_plClipL;
	pr_plClipR = other.pr_plClipR;
	pr_plClipU = other.pr_plClipU;
	pr_plClipD = other.pr_plClipD;
	ppr_FOVWidth = other.ppr_FOVWidth;
	ppr_fMipRatio = other.ppr_fMipRatio;
	ppr_PerspectiveRatios = other.ppr_PerspectiveRatios;
	ppr_fMetersPerPixel = other.ppr_fMetersPerPixel;
	ppr_fViewerDistance = other.ppr_fViewerDistance;
	ppr_boxSubScreen = other.ppr_boxSubScreen;
...
//강동민 수정 시작 테스트 클라이언트 작업	06.29
	...
	{	
	// check to left
	FLOAT fP = fY*pr_plNiceWaterView(2) + fZ*pr_plNiceWaterView(3) - pr_plNiceWaterView.Distance();
	if( fP<-fRadius) 
	{
		return -1;
	} 
...
//강동민 수정 시작 테스트 클라이언트 작업	06.29
	...
	if(gfx_bRenderReflection)
	{	
		iTest = box.TestAgainstPlane(pr_plNiceWaterView);
		if( iTest<0) 
		{
			return -1;
		} 
