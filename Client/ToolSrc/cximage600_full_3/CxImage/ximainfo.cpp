...
#endif
#if CXIMAGE_SUPPORT_LC_TEX
	if (_tcsnicmp(ext,_T("tex"),3)==0 )		return CXIMAGE_FORMAT_LC_TEX;
#endif
...
#endif
#if CXIMAGE_SUPPORT_LC_TEX
	n++; if (index == n) return CXIMAGE_FORMAT_LC_TEX;
#endif
...
#endif
#if CXIMAGE_SUPPORT_LC_TEX
	n++; if (id == CXIMAGE_FORMAT_LC_TEX) return n;
#endif
