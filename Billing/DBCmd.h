...
public:
	...
	int BeginTrans() { return mysql_real_query(m_dbconn, "BEGIN", 5); }
	int Commit()  { return mysql_real_query(m_dbconn, "COMMIT", 6); }
	int Rollback()  { return mysql_real_query(m_dbconn, "ROLLBACK", 8); }
