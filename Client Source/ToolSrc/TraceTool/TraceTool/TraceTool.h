...
public:
	...
	void Add(const int msg, const char* StrValue)
		...
		if (StrValue == NULL)
			...
			#else
			_snprintf(message, MsgLen, "%5d%s", msg, StrValue);
			#endif
			}
		push_back(message);
		free(message);
	...
	void Add(const int msg, const char* StrValue1, const char* StrValue2)
		...
		if (StrValue1 == NULL && StrValue2 == NULL)
			...
			#else
			_snprintf(message, MsgLen, "%5d|%s", msg, StrValue2);
			#endif
			}
			...
			#else
			_snprintf(message, MsgLen, "%5d%s", msg, StrValue1);
			#endif
			}
		else  // both are ok
			{
			...
			#else
			_snprintf(message, MsgLen, "%5d%s|%s", msg, StrValue1, StrValue2);
			#endif
			}
		push_back(message);
		free(message);
	...
	void Add(const int msg, const int intValue)
		...
		#else
		_snprintf(message, 20, "%5d%11d", msg, intValue);      // 5 + 11 + 1
		#endif
		push_back(message);
		}
	//-------------------------------------------------------------------------
	...
	void Add(const int msg, const int intValue, const char* StrValue)
		...
		if (StrValue == NULL)
			...
			#else
			_snprintf(message, 17, "%5d%11d", msg, intValue);
			#endif
			}
		else
			{
			...
			#else
			_snprintf(message, messLen, "%5d%11d%s", msg, intValue, StrValue);  // 5 + 11 + xxx + 1
			#endif
			}
		push_back(message);
		free(message);
	...
	void AddFront(const int msg, const int intValue, const char* StrValue)
		...
		if (StrValue == NULL)
			...
			#else
			_snprintf(message, 17, "%5d%11d", msg, intValue);              // 5 + 11 + 1
			#endif
			}
		else
			{
			...
			#else
			_snprintf(message, mess_len, "%5d%11d%s", msg, intValue, StrValue);  // 5 + 11 + xxx + 1
			#endif
			}
		push_front(message);
		free(message);
	...
	void Add(const int msg, const int int1, const int int2, const char* StrValue)
		...
		if (StrValue == NULL)
			...
			#else
			_snprintf(message, 28, "%5d%11d%11d", msg, int1, int2);               // 5 + 11 + 11 + 1
			#endif
			}
		else
			{
			...
			#else
			_snprintf(message, mess_len, "%5d%11d%11d%s", msg, int1, int2 , StrValue);  // 5 + 11 + 11 + xxx + 1
			#endif
			}
		push_back(message);
		free(message);
	...
	void Add(const int msg, const int int1, const int int2, const int int3, const char* StrValue)
		...
		if (StrValue == NULL)
			...
			#else
			_snprintf(message, 39, "%5d%11d%11d%11d", msg, int1, int2, int3);               // 5 + 11 + 11 + 11 + 1
			#endif
			}
		else
			{
			...
			#else
			_snprintf(message, mess_len, "%5d%11d%11d%11d%s", msg, int1, int2, int3, StrValue);  // 5 + 11 + 11 + 11 + xxx + 1
			#endif
			}
		push_back(message);
		free(message);
	...
	void Add(const int msg, const int int1, const int int2, const int int3, const int int4, const char* StrValue)
		...
		if (value == NULL)
			...
			#if defined(_MSC_VER) && (_MSC_VER >= 1400) && (!UNDER_CE)
			sprintf_s(message, 50, "%5d%11d%11d%11d%11d", msg, int1, int2 , int3, int4);                // 5 + 11 + 11 + 11 + 11 + 1
			#else
			_snprintf(message, 50, "%5d%11d%11d%11d%11d", msg, int1, int2 , int3, int4);                // 5 + 11 + 11 + 11 + 11 + 1
			#endif
			}
		else
			{
			...
			#else
			_snprintf(message, messLen, "%5d%11d%11d%11d%11d%s", msg, int1, int2, int3, int4, StrValue);   // 5 + 11 + 11 + 11 + 11 + xxx + 1
			#endif
			}
		push_back(message);
		free(message);
...
public:
	...
	virtual ~TraceNodeBase() {}          // destructor
};
...
/// </summary>
class TraceToSend : public TraceNodeBase
{
	friend TraceNodeEx;
	friend WinTrace;
	friend TraceNode;
...
public:
	virtual TraceToSend::~TraceToSend() { DeleteCriticalSection(&criticalSection); }

	// The most usefull function in that library
	void Send(const char*    leftMsg, const char*    rightMsg = NULL);
	void Send(const wchar_t* leftMsg, const wchar_t* rightMsg = NULL);
	...
	void Indent(const wchar_t* leftMsg, const wchar_t* rightMsg, int BackGroundColor, bool IsEnter);
	...
	void SendDump(const wchar_t* leftMsg, const wchar_t* rightMsg, const wchar_t* title, const char* memory, const unsigned byteCount);
...
/// </summary>
class TraceNode : public TraceToSend
{
	friend WinTrace;
	friend TraceToSend;
...
/// </summary>
class TraceNodeEx : public TraceNodeBase //Base
{
...
class WinTrace : public TraceToSend
{
...
public:
	...
	TraceToSend* Debug() { return debug; }

	/// Warning, Error and Debug are the 3 doors to send traces
	/// <returns>The warning node</returns>
	TraceToSend* Warning() { return warning; }

	/// Warning, Error and Debug are the 3 doors to send traces
	/// <returns>The Error node</returns>
	TraceToSend* Error() { return error; }
	...
	// Plugin API.
	void CreateResource(const int ResId, const int ResType, const int ResWidth, const char*    ResText = NULL);
	void CreateResource(const int ResId, const int ResType, const int ResWidth, const wchar_t* ResText = NULL);
...
private:
	...
	static map<string, WinTrace*>* m_winTraceList;
	static map<string, WinWatch*>* m_winWatchList;
...
public:
	...
	static TraceToSend* Debug() { return m_winTrace->debug; }

	/// Shortcut to WinTrace.Warning
	/// <returns>WinTrace.Warning</returns>
	static TraceToSend* Warning() { return m_winTrace->warning; }

	/// Shortcut to WinTrace.Error
	/// <returns>WinTrace.Error</returns>
	static TraceToSend* Error() { return m_winTrace->error; }
	...
	static WinTrace* GetWinTrace(const char* winTraceId);
	static WinWatch* GetWinWatch(const char* winWatchId);
	static void SendToWinTrace(const char* winTraceId, const char* leftMsg, const char* rightMsg = NULL);
	static void SendToWinWatch(const char* winWatchId, const char* watchName, const char* watchValue);
	static void SendToWinTraceDump(const char* winTraceId, const char* title, const char* buf, unsigned int bufLen, const char* rightMsg = NULL);
