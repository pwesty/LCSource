...
__forceinline DOUBLE Vector<DOUBLE,3>::Magnitude(void) const
{
	return (DOUBLE)((*this)(1)*(*this)(1) + (*this)(2)*(*this)(2) + (*this)(3)*(*this)(3));
}
template<class Type, int iDimensions>
__forceinline Type Vector<Type, iDimensions>::Magnitude(void) const
{
	Type result=(Type)0;
