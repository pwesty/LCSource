...
#define TEM_LAYER			1
#define TEM_SHADOWMAP		2		// yjpark
#define TEM_ATTRIBUTEMAP	3		// yjpark

#define CT_EDIT_MODES 4		// yjpark
...
extern void DisplayAttributeMapWindow(CPoint pt);
...
public:
  ...
  void InitializeInterface();				// yjpark
