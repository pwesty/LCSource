...
static int _iLine;
static BOOL dbg_bCheckTranslations = FALSE;
...
ENGINE_API void InitTranslation(void)
{
	...
	_pShell->DeclareSymbol("user INDEX dbg_bCheckTranslations;", &dbg_bCheckTranslations);
}
