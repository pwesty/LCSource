/*
 *  Viewers.cpp - Master and Slave viewer implementation
 *  World Editor
...
//안태훈 수정 시작	//(Modify Fov)(0.1)
  ANGLE aHalfI = AngleDeg(60.0f)/2;     // assume FOV of 90 degrees for perspective
//안태훈 수정 끝	//(Modify Fov)(0.1)
...
//안태훈 수정 시작	//(Modify Fov)(0.1)
  prPerspectiveProjection.FOVL() = AngleDeg(60.0f);
//안태훈 수정 끝	//(Modify Fov)(0.1)
