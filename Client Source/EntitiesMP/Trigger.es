...
/******************/
 ...
 41 CEntityPointer m_penCaused features(EPROPF_NETSEND),     // who touched it last time
 42 INDEX m_ctMaxTrigs            "Max trigs" 'X' = -1 features(EPROPF_NETSEND), // how many times could trig


components:

  1 editor model   MODEL_MARKER     "Data\\Models\\Editor\\Trigger.mdl",
  2 editor texture TEXTURE_MARKER   "Data\\Models\\Editor\\Camera.tex"
