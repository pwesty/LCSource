...
event EModel2Activate {
};
event EModel2Deactivate {
};
...
//강동민 수정 시작
	3 ST_PROJECTION "Projection Shadows"
//강동민 수정 끝
};
...
//안태훈 수정 시작	//(Effect Add & Modify for Close Beta)(0.1)
 28 COLOR m_colModelColor		"Model Color" = (C_WHITE|CT_OPAQUE),
		...
		case CST_CONSTANT_SHADING:
			{
				...
				SetFlagOff(ENF_CUSTOMSHADING); // signal to engin
				break;
			}
		case CST_NONE:
			{
